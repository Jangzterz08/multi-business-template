# AI Talking Head Script 30s for 2026-03-19

Voice: Creator

Lead story: Anthropic turns the tables on OpenAI in critical revenue category

## Beat timing

0-5s: Hook
The biggest AI story this morning is Anthropic turns the tables on OpenAI in critical revenue category.

5-15s: What changed
Anthropic turns the tables on OpenAI in critical revenue category is the kind of headline that looks broad until you map what it changes for builders, buyers, or distribution.
...
1. The headline is Anthropic turns the tables on OpenAI in critical revenue category. The real story is what it changes.
