# AI Talking Head Script 30s for 2026-03-20
...
0-5s: Hook
The biggest AI story this morning is OpenAI to buy Python toolmaker Astral to take on Anthropic.

5-15s: What changed
OpenAI to buy Python toolmaker Astral to take on Anthropic is the kind of headline that looks broad until you map what it changes for builders, buyers, or distribution.
...
1. The headline is OpenAI to buy Python toolmaker Astral to take on Anthropic. The real story is what it changes.
