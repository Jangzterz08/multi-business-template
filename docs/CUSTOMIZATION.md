...
If you configure Telegram, each run also sends a short phone-friendly morning message. In GitHub Actions, store the bot token in `Secrets` and the chat id in `Variables`.
